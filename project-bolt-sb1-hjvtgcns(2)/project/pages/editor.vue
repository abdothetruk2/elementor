    ...
    <div class="editor-container flex h-screen pt-14 w-full">
      ...
      <div class="editor-sidebar w-64 bg-gray-800 text-white h-full overflow-y-auto flex flex-col">
        ...
        <div v-if="activeTab === 'Elements'" class="p-4 flex-1 overflow-y-auto">
          ...
          <div class="mb-6">
            <h3 class="text-xs uppercase text-gray-400 font-medium mb-3">Navigation Elements</h3>
            <div class="grid grid-cols-2 gap-2">
              <WidgetItem 
                v-for="widget in navigationWidgets" 
                :key="widget.type" 
                :widget="widget" 
                @select="handleWidgetSelect"
              />
      ...
      <!-- Main Content Area -->
      <div class="editor-content flex-1 bg-gray-100 overflow-y-auto w-full">
...
const advancedWidgets = [
  ...
  { type: 'form', label: 'Form', icon: 'document-text' },
  { type: 'gallery', label: 'Gallery', icon: 'photograph' },
  { type: 'social', label: 'Social', icon: 'share' },
  { type: 'accordion', label: 'Accordion', icon: 'menu' },
  { type: 'tabs', label: 'Tabs', icon: 'view-boards' }
];
...
const navigationWidgets = [
  { 
    ...
    content: {
      ...
      title: 'ElementorClone',
      menuItems: [
        { id: '1', text: 'Home', url: '/' },
        { id: '2', text: 'About', url: '/about' },
        { id: '3', text: 'Contact', url: '/contact' },
        { id: '4', text: 'Privacy', url: '/privacy' },
        { id: '5', text: 'Terms', url: '/terms' }
      ]
    }
  }
];
...
function getDefaultContent(type) {
  const defaults = {
    ...
    accordion: {
      items: [
        { id: '1', title: 'Accordion Item 1', content: 'Content for accordion item 1' },
        { id: '2', title: 'Accordion Item 2', content: 'Content for accordion item 2' },
        { id: '3', title: 'Accordion Item 3', content: 'Content for accordion item 3' }
      ]
    },
    tabs: {
      tabs: [
